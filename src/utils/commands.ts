...
import {
  ...
  beanAopMethod,
  beanMiddleware,
  beanMiddlewareGlobal,
  beanMiddlewareSystem,
  beanGuard,
  beanGuardGlobal,
  beanInterceptor,
  beanInterceptorGlobal,
  beanPipe,
  beanPipeGlobal,
  beanFilter,
  beanFilterGlobal,
...
const extensionCommands = [
  ...
  { command: 'vona.beanMiddlewareGlobal', function: beanMiddlewareGlobal },
  { command: 'vona.beanMiddlewareSystem', function: beanMiddlewareSystem },
  { command: 'vona.beanGuard', function: beanGuard },
  { command: 'vona.beanGuardGlobal', function: beanGuardGlobal },
  { command: 'vona.beanInterceptor', function: beanInterceptor },
  { command: 'vona.beanInterceptorGlobal', function: beanInterceptorGlobal },
  { command: 'vona.beanPipe', function: beanPipe },
  { command: 'vona.beanPipeGlobal', function: beanPipeGlobal },
  { command: 'vona.beanFilter', function: beanFilter },
  { command: 'vona.beanFilterGlobal', function: beanFilterGlobal },
  { command: 'vona.beanSocketNamespace', function: beanSocketNamespace },
  ...
  { command: 'vona.beanCaptchaProvider', function: beanCaptchaProvider },
  ...
  { command: 'vona.beanFilterTransform', function: beanFilterTransform },
